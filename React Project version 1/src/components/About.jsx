  ...
  return (
    <div>
      ...
      <div className="bg-secondary d-flex align-items-center justify-content-center">
        <div className="text-center my-5">
          <h2 className="text-light py-2">About Our Store</h2>
          <p className="text-light py-2" style={{  paddingRight: '1em', paddingLeft: '1em' }}>
          ...
          <p className="text-light py-2" style={{  paddingRight: '1em', paddingLeft: '1em' }}>
          We value your trust and strive to build long-lasting relationships with our customers. That's why we go the extra mile to ensure secure transactions, reliable shipping, and hassle-free returns. Your happiness is our success.
          </p>
          <p className="text-light py-2" style={{  paddingRight: '1em', paddingLeft: '1em' }}>
          Thank you for choosing SAY Store. We invite you to explore our website, discover amazing deals and offers, and embark on a delightful shopping journey. Happy shopping!
          </p>
          <p className="text-light py-2" style={{  paddingRight: '1em', paddingLeft: '1em' }}>
          Feel free to customize and modify the text according to the specific details and brand identity of your e-commerce website.
          </p>
        </div>
      </div>
    </div>
